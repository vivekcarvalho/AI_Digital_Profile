...
def render_cta():
    ...
    st.divider()
    st.markdown(body= """
        <div style='text-align: center; color: gray; font-size: 0.9em; line-height: 1.6;'>
            <br>Want to Collaborate ? <br>Reach out to me at → 
                    <a href="mailto:vivek_carvalho@yahoo.co.in"
                    style="color: #4a6fa5; font-weight: bold; text-decoration: none;">
                    ✉️ Email
                    </a>
                &nbsp;|&nbsp;
                    <a href="https://www.linkedin.com/in/vivekcarvalho/" target="_blank"
                    style="color: #0a66c2; font-weight: bold; text-decoration: none;">
                    <svg height="14" viewBox="0 0 24 24" style="vertical-align: -2px; margin-right: 4px;"
                    fill="currentColor" aria-hidden="true">
                    <path d="M20.45 20.45h-3.55v-5.4c0-1.29-.02-2.95-1.8-2.95
                    -1.8 0-2.07 1.4-2.07 2.85v5.5H9.48V9h3.41v1.56h.05
                    c.47-.9 1.63-1.85 3.36-1.85 3.59 0 4.25 2.36 4.25 5.44v6.3zM5.34 7.43
                    c-1.14 0-2.06-.92-2.06-2.06 0-1.14.92-2.06 2.06-2.06
                    1.14 0 2.06.92 2.06 2.06 0 1.14-.92 2.06-2.06 2.06zM7.12 20.45H3.56V9h3.56v11.45zM22.23 0H1.77
                    C.79 0 0 .77 0 1.72v20.55C0 23.23.79 24 1.77 24h20.46
                    C23.2 24 24 23.23 24 22.27V1.72C24 .77 23.2 0 22.23 0z"></path>
                    </svg>
                    LinkedIn
                    </a>
                &nbsp;|&nbsp;
                    <a href="https://github.com/vivekcarvalho" target="_blank"
                    style="color: #333; font-weight: bold; text-decoration: none;">
                    <svg height="14" viewBox="0 0 16 16" style="vertical-align: -2px; margin-right: 4px;"
                    fill="currentColor" aria-hidden="true">
                    <path d="M8 0C3.58 0 0 3.58 0 8a8 8 0 005.47 7.59c.4.07.55-.17.55-.38
                    0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13
                    -.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66
                    .07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15
                    -.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82a7.65 7.65 0 012-.27c.68 0 1.36.09
